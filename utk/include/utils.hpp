...
inline std::string getExt(std::string f, std::string default_value)
{
...
inline std::string getBasename(std::string f)
{
...
inline bool* toBitList(unsigned long long int a, unsigned int size)
{
